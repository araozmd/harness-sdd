...
# the target is a DIFFERENT product — reset its verification commands to blank;
# they get filled in during bootstrap.
_cfg="$H/harness.config.yaml"
...
HARNESS-OWNED  (overwritten on every upgrade):
  .harness/AGENTS.md  .harness/harness.config.yaml  .harness/init.sh
